...
def main():
    ...
    col.create_index([("site_url", -1)])  # INDEX
    col.create_index([("published", -1)])  # INDEX

    #Caricamento dati di aggregazione
...
def ricerca_risultato():
    ...
    if(tipo_ricerca == "ricerca_date"):
        ...
        list_title = Query.query_for_date(testo)
    ...
    if(tipo_ricerca == "ricerca_author"):
        ...
        list_title = Query.query_for_author(testo)
    ...
    if(tipo_ricerca == "ricerca_site"):
        ...
        list_title = Query.query_for_site(testo)
